...
test('local・staging・trialは同じ修正済みFrontend資産を使う', async () => {
  ...
  for (const html of [index, staging, trial]) {
    assert.match(html, /assets\/css\/styles\.css\?v=20260902-28/);
    assert.match(html, /assets\/js\/bootstrap\.js\?v=20260902-28/);
  }
  assert.match(bootstrap, /\.\/app\.js\?v=20260902-28/);
});
